...
<div class="card bg-base-100/80 backdrop-blur-xl shadow-2xl border border-white/10 overflow-hidden">
	<div class="card-body p-8">
		<div class="text-center mb-8">
			<div class="inline-block p-3 rounded-2xl bg-secondary/10 mb-4">
				<svg
			...
			<p class="opacity-60 text-sm">Join Scriptus and start transcribing today</p>
		</div>
		...
		<div class="text-center mt-8 text-sm opacity-60">
			Already have an account? <a
				href="/auth/login"
				class="link link-primary font-bold hover:no-underline">Sign in</a
			>
		</div>
	</div>
</div>
